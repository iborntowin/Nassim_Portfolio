...
import { ArrowLeft, Github, Star, GitFork, GitCommit, Calendar, Users, User, Zap, Target, Lightbulb, CheckCircle, Shield, Network, Cloud, Server } from 'lucide-react'
  ...
  const architectureFeatures = [
    {
      icon: Server,
      title: 'Compute (Nova)',
      description: 'Full VM lifecycle management with multi-hypervisor support and Heat orchestration',
      color: 'text-red-500'
    },
    {
      icon: Network,
      title: 'Networking (Neutron)',
      description: 'Software-defined networking with tenant isolation, floating IPs, and security groups',
      color: 'text-blue-500'
    },
    {
      icon: Cloud,
      title: 'Storage (Cinder + Swift)',
      description: 'Persistent block storage and distributed object storage with multi-replica durability',
      color: 'text-amber-500'
    },
    {
      icon: Shield,
      title: 'Security & Monitoring',
      description: 'WAF, Security Groups, Prometheus metrics, and Grafana dashboards for full observability',
    ...
    <>
      ...
      <div className="min-h-screen bg-[var(--color-primary-background)]">
        ...
        <section className="relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-red-500/5 via-[var(--color-primary-accent)]/5 to-blue-500/5"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <Badge className="bg-gradient-to-r from-red-500 to-blue-500 text-white border-none">
                    Flagship
                  </Badge>
                ...
                <div className="flex gap-4">
                  <Button
                    className="bg-gradient-to-r from-red-500 to-blue-500 hover:from-red-400 hover:to-blue-400 text-white px-6 py-3 shadow-lg"
                    asChild
                  >
              ...
              >
                <div className="relative rounded-2xl overflow-hidden shadow-2xl ring-1 ring-red-500/20">
                  <Image
                    ...
                    alt="OpenStack Infrastructure Dashboard"
                    width={600}
                    height={400}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-[var(--color-text-secondary)] max-w-3xl mx-auto">
                A fully deployed OpenStack private cloud — compute, networking, storage, security, 
                and monitoring — automated with Heat and validated end-to-end.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {architectureFeatures.map((feature, index) => (
                ...
                >
                  <Card className="bg-[var(--color-primary-background)] border-[var(--color-border)] h-full hover:border-red-500/30 transition-all duration-300 group">
        ...
        {/* Premium Infrastructure Showcase */}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-[var(--color-text-secondary)] mb-8">
                Explore the infrastructure code, learn about the architecture, or get in touch to discuss cloud projects.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  className="bg-gradient-to-r from-red-500 to-blue-500 hover:from-red-400 hover:to-blue-400 text-white px-8 py-3 shadow-lg"
                  asChild
                >
                  <a href={project.githubUrl} target="_blank" rel="noopener noreferrer">
                    <Github className="w-4 h-4 mr-2" />
